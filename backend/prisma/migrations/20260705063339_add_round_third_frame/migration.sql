...
CREATE TABLE "new_Round" (
    ...
    CONSTRAINT "Round_thirdFrameId_fkey" FOREIGN KEY ("thirdFrameId") REFERENCES "Frame" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Round" ("answerText", "answeredAt", "attemptCount", "frameId", "hintsUsed", "id", "isCorrect", "roundIndex", "score", "secondFrameId", "sessionId", "startedAt") SELECT "answerText", "answeredAt", "attemptCount", "frameId", "hintsUsed", "id", "isCorrect", "roundIndex", "score", "secondFrameId", "sessionId", "startedAt" FROM "Round";
DROP TABLE "Round";
